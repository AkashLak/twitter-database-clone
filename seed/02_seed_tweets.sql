...
(164,  2, 'Just finished migrating a monolith to services. The hardest part was not the code — it was agreeing on service boundaries. Conway''s Law is real.', 'original', NULL, NULL, '2025-05-08 11:00:00'),
(165,  8, 'New benchmark results are in. The gap between frontier model capability and reliable deployment keeps widening. Evaluation is not keeping up. #AI #research', 'original', NULL, NULL, '2025-03-05 10:30:00'),
(166,  8, 'Spent the summer working on mechanistic interpretability. The more I look inside these models the more I think we are building things we do not fully understand.', 'original', NULL, NULL, '2025-08-01 14:00:00'),
(167, 13, 'dbt + DuckDB for local development is a game changer. Full analytics stack on a laptop with no cloud bill. #dataengineering #dbt', 'original', NULL, NULL, '2025-04-15 10:00:00'),
(168, 13, 'End of year wrap: shipped 4 major dashboards, decommissioned 2 legacy pipelines, and finally convinced the team to write tests for SQL. Progress.', 'original', NULL, NULL, '2025-12-15 16:00:00'),
(169, 32, 'The open source vs. closed model debate shifted again this week. When open weights models match proprietary benchmarks the conversation changes. #AI #llm', 'original', NULL, NULL, '2025-06-01 09:00:00'),
(170, 32, 'Three things from this week in AI: multimodal reasoning improvements, a surprising interpretability paper, and two more labs announcing compute clusters. Thread below.', 'original', NULL, NULL, '2025-09-15 10:00:00'),
(171,  6, 'New piece out: how algorithmic recommendation feeds are reshaping what "news" even means for under-30 audiences. Link in bio.', 'original', NULL, NULL, '2025-07-10 11:00:00'),
(172,  4, 'BREAKING: Major infrastructure bill passes committee with bipartisan support. Full text and analysis developing. #news', 'original', NULL, NULL, '2025-08-20 16:00:00'),
(173, 18, 'MLOps in 2025: the tooling matured but the cultural problems stayed the same. Data scientists and engineers still fighting over ownership. #MLOps', 'original', NULL, NULL, '2025-09-15 09:30:00'),
(174, 25, 'Zero-day disclosed in a widely used auth library today. If you are using it — patch now, ask questions later. CVE link in replies. #security #infosec', 'original', NULL, NULL, '2025-10-05 08:00:00'),
(175, 30, 'Hot take: the data lakehouse pattern solves problems most teams do not have yet. Start with a well-modeled data warehouse. Boring wins. #dataengineering', 'original', NULL, NULL, '2025-11-12 13:00:00'),
(176,  7, 'Platform engineering is just DevOps with better marketing. I say this with love — the developer experience focus is genuinely good. #devops #platformengineering', 'original', NULL, NULL, '2025-12-01 09:00:00'),
(177,  8, 'New paper: we find systematic reasoning failures in current frontier models on novel combinatorial tasks. The gap between benchmark performance and real robustness is larger than reported. #AI', 'original', NULL, NULL, '2026-01-10 10:30:00'),
(178,  2, 'Postgres 18 features are looking very good. The improvements to EXPLAIN output alone would have sold me. Always bet on Postgres. #databases #sql', 'original', NULL, NULL, '2026-01-25 11:00:00'),
(179, 32, 'Tracking agent frameworks this month: the explosion of agentic tooling is real but production reliability stories are still thin. Who has shipped agents that actually work at scale?', 'original', NULL, NULL, '2026-02-08 10:00:00'),
(180,  1, 'Finally migrated our last service off Python 3.9. The type checker found 11 latent bugs in the process. Types are documentation that runs. #programming #python', 'original', NULL, NULL, '2026-02-20 14:00:00'),
(181,  6, 'Finished a 6-month investigation into how recommendation algorithms amplify health misinformation. The findings are more serious than I expected. Publishing Tuesday.', 'original', NULL, NULL, '2026-03-05 11:00:00'),
(182,  2, 'Column-oriented storage for OLAP, row-oriented for OLTP — still the most important database design decision nobody talks about enough in interviews. #databases', 'original', NULL, NULL, '2026-03-12 10:00:00'),
(183,  8, 'Gave a talk today on evaluation methodology for AI systems in high-stakes settings. The room was full of engineers who had never thought about this. We have work to do. #AI #research', 'original', NULL, NULL, '2026-03-20 16:00:00'),
(184,  1, 'Shipped a feature today that I prototyped two years ago and shelved. Sometimes the timing is the product. #programming', 'original', NULL, NULL, '2026-03-28 15:00:00'),
(185, 13, 'Q1 data review done. Three dashboards that were being used daily six months ago now have zero sessions. Always audit your analytics estate. #dataengineering', 'original', NULL, NULL, '2026-04-02 11:00:00'),
(186, 32, 'This week: two major model releases, an agent benchmark paper that broke Twitter, and a quiet acquisition that everyone missed. All in the newsletter. #AI #llm', 'original', NULL, NULL, '2026-04-07 09:00:00');
